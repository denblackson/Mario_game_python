...
# monsters.py
MONSTER_WIDTH, MONSTER_HEIGHT, MONSTER_COLOR = 50, 50, '#2111FF'
ICON_DIR = os.path.dirname(__file__)
#ANIMATION_MONSTER_HORIZONTAL = [('%s/monsters/fire1.png' % ICON_DIR), ('%s/monsters/fire2.png' % ICON_DIR)]
ANIMATION_MONSTER_HORIZONTAL = [('%s/monsters/photo_2021-11-18_18-55-12.png' % ICON_DIR), ('%s/monsters/photo_2021-11-18_18-55-12.png' % ICON_DIR)]


# blocks.py
PLATFORM_WIDTH, PLATFORM_HEIGHT, PLATFORM_COLOR = 32, 32, '#000000'
# ICON_DIR = os.path.dir-name(__file__)
...
ANIMATION_PRINCESS = [('%s/blocks/dmitrij-gordon-2.png' % ICON_DIR), ('%s/blocks/dmitrij-gordon-2.png' % ICON_DIR)]
